...
MCP23008::MCP23008(TwoWire& bus) {
	_deviceAddr = MCP23008_I2C_ADDRESS;
	_bus = &bus;
}
...
void MCP23008::init()
{
	...
	//HAEN = 	0 : hardware address pin is always enabled on 23008
...
uint8_t MCP23008::interruptedBy()
{
	return readRegister(MCP23008Register::INTF);
}
...
uint8_t MCP23008::clearInterrupts()
{
	return readRegister(MCP23008Register::INTCAP);
}
